...
implicit none
            ...
            DO k=1,n
                    ...
                    IF (v(k,2)>0 ) THEN
                        ...
                        END IF 
                            ...
                            IF (tcol<colt ) THEN
                                ! PRINT*, 'colisión:',k,n+1,'tiempo',tcol
                                colt=tcol
                                ni(1)=k
                                ni(2)=n+1
                            END IF
                    ...
                    IF (v(k,2)<0 ) THEN
                        tcol=(sigma*0.5-r(k,2))/v(k,2)
                            ...
                            IF (tcol<colt) THEN
                                ! PRINT*, 'colisión:',k,n+2,'tiempo',tcol
                            colt=tcol
                            ni(1)=k
                            ni(2)=n+2
                            END IF
    ...
    CONTAINS
      ...
      SUBROUTINE collide_granular ( a, b,alpha)
        ...
        v(a,:) = v(a,:) + vij*(1+alpha)/2.0
        v(b,:) = v(b,:) - vij*(1+alpha)/2.0
            ! PRINT*, "velocidad particula 1",v(i,:)
            ! PRINT*, "velocidad particula 2,",v(j,:)
